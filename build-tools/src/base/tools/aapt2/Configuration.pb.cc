...
PROTOBUF_CONSTEXPR Configuration::Configuration(
  ...
  , /*decltype(_impl_.grammatical_gender_)*/0
...
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_Configuration_2eproto[15];
...
const uint32_t TableStruct_Configuration_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::aapt::pb::Configuration, _impl_.grammatical_gender_),
...
const ::_pbi::DescriptorTable descriptor_table_Configuration_2eproto = {
    false, false, 2900, descriptor_table_protodef_Configuration_2eproto,
    "Configuration.proto",
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Configuration_GrammaticalGender_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_Configuration_2eproto);
  return file_level_enum_descriptors_Configuration_2eproto[14];
}
...
#if (__cplusplus < 201703) && (!defined(_MSC_VER) || (_MSC_VER >= 1900 && _MSC_VER < 1912))
constexpr Configuration_GrammaticalGender Configuration::GRAM_GENDER_USET;
constexpr Configuration_GrammaticalGender Configuration::GRAM_GENDER_NEUTER;
constexpr Configuration_GrammaticalGender Configuration::GRAM_GENDER_FEMININE;
constexpr Configuration_GrammaticalGender Configuration::GRAM_GENDER_MASCULINE;
constexpr Configuration_GrammaticalGender Configuration::GrammaticalGender_MIN;
constexpr Configuration_GrammaticalGender Configuration::GrammaticalGender_MAX;
constexpr int Configuration::GrammaticalGender_ARRAYSIZE;
#endif  // (__cplusplus < 201703) && (!defined(_MSC_VER) || (_MSC_VER >= 1900 && _MSC_VER < 1912))
...
Configuration::Configuration(const Configuration& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.grammatical_gender_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  ::memcpy(&_impl_.mcc_, &from._impl_.mcc_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.grammatical_gender_) -
    reinterpret_cast<char*>(&_impl_.mcc_)) + sizeof(_impl_.grammatical_gender_));
    ...
    switch (tag >> 3) {
      ...
      case 26:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 208)) {
          uint64_t val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          _internal_set_grammatical_gender(static_cast<::aapt::pb::Configuration_GrammaticalGender>(val));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* Configuration::_InternalSerialize(
  ...
  // .aapt.pb.Configuration.GrammaticalGender grammatical_gender = 26;
  if (this->_internal_grammatical_gender() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteEnumToArray(
      26, this->_internal_grammatical_gender(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:aapt.pb.Configuration)
  ...
  if (this->_internal_grammatical_gender() != 0) {
    total_size += 2 +
      ::_pbi::WireFormatLite::EnumSize(this->_internal_grammatical_gender());
  }
...
void Configuration::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_grammatical_gender() != 0) {
    _this->_internal_set_grammatical_gender(from._internal_grammatical_gender());
  }
...
void Configuration::InternalSwap(Configuration* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Configuration, _impl_.grammatical_gender_)
      + sizeof(Configuration::_impl_.grammatical_gender_)
