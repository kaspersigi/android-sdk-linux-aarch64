...
PROTOBUF_CONSTEXPR CompiledFile::CompiledFile(
  ...
  , /*decltype(_impl_.uses_readwrite_feature_flags_)*/false
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
const uint32_t TableStruct_ResourcesInternal_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::aapt::pb::internal::CompiledFile, _impl_.flag_status_),
  PROTOBUF_FIELD_OFFSET(::aapt::pb::internal::CompiledFile, _impl_.flag_negated_),
  PROTOBUF_FIELD_OFFSET(::aapt::pb::internal::CompiledFile, _impl_.flag_name_),
  PROTOBUF_FIELD_OFFSET(::aapt::pb::internal::CompiledFile, _impl_.uses_readwrite_feature_flags_),
};
...
const ::_pbi::DescriptorTable descriptor_table_ResourcesInternal_2eproto = {
    false, false, 499, descriptor_table_protodef_ResourcesInternal_2eproto,
...
CompiledFile::CompiledFile(const CompiledFile& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.uses_readwrite_feature_flags_){}
    , /*decltype(_impl_._cached_size_)*/{}};
  ...
  ::memcpy(&_impl_.type_, &from._impl_.type_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.uses_readwrite_feature_flags_) -
    reinterpret_cast<char*>(&_impl_.type_)) + sizeof(_impl_.uses_readwrite_feature_flags_));
...
// @@protoc_insertion_point(message_clear_start:aapt.pb.internal.CompiledFile)
  ...
  ::memset(&_impl_.type_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.uses_readwrite_feature_flags_) -
      reinterpret_cast<char*>(&_impl_.type_)) + sizeof(_impl_.uses_readwrite_feature_flags_));
  _internal_metadata_.Clear<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
    ...
    switch (tag >> 3) {
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 66)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "aapt.pb.internal.CompiledFile.flag_name"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 9:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 72)) {
          _impl_.uses_readwrite_feature_flags_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* CompiledFile::_InternalSerialize(
  ...
  if (this->_internal_flag_status() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(6, this->_internal_flag_status(), target);
  }

  // bool flag_negated = 7;
  if (this->_internal_flag_negated() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(7, this->_internal_flag_negated(), target);
  }
  ...
  if (!this->_internal_flag_name().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "aapt.pb.internal.CompiledFile.flag_name");
    target = stream->WriteStringMaybeAliased(
        8, this->_internal_flag_name(), target);
  }

  // bool uses_readwrite_feature_flags = 9;
  if (this->_internal_uses_readwrite_feature_flags() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(9, this->_internal_uses_readwrite_feature_flags(), target);
  }
...
void CompiledFile::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  if (from._internal_uses_readwrite_feature_flags() != 0) {
    _this->_internal_set_uses_readwrite_feature_flags(from._internal_uses_readwrite_feature_flags());
  }
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
...
void CompiledFile::InternalSwap(CompiledFile* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(CompiledFile, _impl_.uses_readwrite_feature_flags_)
      + sizeof(CompiledFile::_impl_.uses_readwrite_feature_flags_)
