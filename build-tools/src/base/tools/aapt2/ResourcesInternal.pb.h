...
class CompiledFile_Symbol final :
 ...
 public:
  ...
  CompiledFile_Symbol* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
...
class CompiledFile final :
 ...
 public:
  ...
  CompiledFile* New(::PROTOBUF_NAMESPACE_ID::Arena* arena = nullptr) const final {
  ...
  enum : int {
    ...
    kFlagNameFieldNumber = 8,
    kConfigFieldNumber = 2,
    kTypeFieldNumber = 3,
    kFlagStatusFieldNumber = 6,
    kFlagNegatedFieldNumber = 7,
    kUsesReadwriteFeatureFlagsFieldNumber = 9,
  };
  ...
  void clear_uses_readwrite_feature_flags();
  bool uses_readwrite_feature_flags() const;
  void set_uses_readwrite_feature_flags(bool value);
  private:
  bool _internal_uses_readwrite_feature_flags() const;
  void _internal_set_uses_readwrite_feature_flags(bool value);
  public:
 ...
 private:
  ...
  struct Impl_ {
    ...
    bool flag_negated_;
    bool uses_readwrite_feature_flags_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_ResourcesInternal_2eproto;
...
// uint32 flag_status = 6;
inline void CompiledFile::clear_flag_status() {
  _impl_.flag_status_ = 0u;
}
inline uint32_t CompiledFile::_internal_flag_status() const {
  return _impl_.flag_status_;
}
inline uint32_t CompiledFile::flag_status() const {
  // @@protoc_insertion_point(field_get:aapt.pb.internal.CompiledFile.flag_status)
  return _internal_flag_status();
}
inline void CompiledFile::_internal_set_flag_status(uint32_t value) {
  
  _impl_.flag_status_ = value;
}
inline void CompiledFile::set_flag_status(uint32_t value) {
  _internal_set_flag_status(value);
  // @@protoc_insertion_point(field_set:aapt.pb.internal.CompiledFile.flag_status)
}

// bool flag_negated = 7;
inline void CompiledFile::clear_flag_negated() {
  _impl_.flag_negated_ = false;
}
inline bool CompiledFile::_internal_flag_negated() const {
  return _impl_.flag_negated_;
}
inline bool CompiledFile::flag_negated() const {
  // @@protoc_insertion_point(field_get:aapt.pb.internal.CompiledFile.flag_negated)
  return _internal_flag_negated();
}
inline void CompiledFile::_internal_set_flag_negated(bool value) {
  
  _impl_.flag_negated_ = value;
}
inline void CompiledFile::set_flag_negated(bool value) {
  _internal_set_flag_negated(value);
  // @@protoc_insertion_point(field_set:aapt.pb.internal.CompiledFile.flag_negated)
}

// string flag_name = 8;
inline void CompiledFile::clear_flag_name() {
  _impl_.flag_name_.ClearToEmpty();
}
inline const std::string& CompiledFile::flag_name() const {
  // @@protoc_insertion_point(field_get:aapt.pb.internal.CompiledFile.flag_name)
  return _internal_flag_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void CompiledFile::set_flag_name(ArgT0&& arg0, ArgT... args) {
 
 _impl_.flag_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:aapt.pb.internal.CompiledFile.flag_name)
}
inline std::string* CompiledFile::mutable_flag_name() {
  std::string* _s = _internal_mutable_flag_name();
  // @@protoc_insertion_point(field_mutable:aapt.pb.internal.CompiledFile.flag_name)
  return _s;
}
inline const std::string& CompiledFile::_internal_flag_name() const {
  return _impl_.flag_name_.Get();
}
inline void CompiledFile::_internal_set_flag_name(const std::string& value) {
  
  _impl_.flag_name_.Set(value, GetArenaForAllocation());
}
inline std::string* CompiledFile::_internal_mutable_flag_name() {
  
  return _impl_.flag_name_.Mutable(GetArenaForAllocation());
}
inline std::string* CompiledFile::release_flag_name() {
  // @@protoc_insertion_point(field_release:aapt.pb.internal.CompiledFile.flag_name)
  return _impl_.flag_name_.Release();
}
inline void CompiledFile::set_allocated_flag_name(std::string* flag_name) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:aapt.pb.internal.CompiledFile.flag_name)
}

// bool uses_readwrite_feature_flags = 9;
inline void CompiledFile::clear_uses_readwrite_feature_flags() {
  _impl_.uses_readwrite_feature_flags_ = false;
}
inline bool CompiledFile::_internal_uses_readwrite_feature_flags() const {
  return _impl_.uses_readwrite_feature_flags_;
}
inline bool CompiledFile::uses_readwrite_feature_flags() const {
  // @@protoc_insertion_point(field_get:aapt.pb.internal.CompiledFile.uses_readwrite_feature_flags)
  return _internal_uses_readwrite_feature_flags();
}
inline void CompiledFile::_internal_set_uses_readwrite_feature_flags(bool value) {
  
  _impl_.uses_readwrite_feature_flags_ = value;
}
inline void CompiledFile::set_uses_readwrite_feature_flags(bool value) {
  _internal_set_uses_readwrite_feature_flags(value);
  // @@protoc_insertion_point(field_set:aapt.pb.internal.CompiledFile.uses_readwrite_feature_flags)
}
