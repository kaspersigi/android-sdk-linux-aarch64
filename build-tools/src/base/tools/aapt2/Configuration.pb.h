...
enum Configuration_GrammaticalGender : int {
  Configuration_GrammaticalGender_GRAM_GENDER_USET = 0,
  Configuration_GrammaticalGender_GRAM_GENDER_NEUTER = 1,
  Configuration_GrammaticalGender_GRAM_GENDER_FEMININE = 2,
  Configuration_GrammaticalGender_GRAM_GENDER_MASCULINE = 3,
  Configuration_GrammaticalGender_Configuration_GrammaticalGender_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  Configuration_GrammaticalGender_Configuration_GrammaticalGender_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool Configuration_GrammaticalGender_IsValid(int value);
constexpr Configuration_GrammaticalGender Configuration_GrammaticalGender_GrammaticalGender_MIN = Configuration_GrammaticalGender_GRAM_GENDER_USET;
constexpr Configuration_GrammaticalGender Configuration_GrammaticalGender_GrammaticalGender_MAX = Configuration_GrammaticalGender_GRAM_GENDER_MASCULINE;
constexpr int Configuration_GrammaticalGender_GrammaticalGender_ARRAYSIZE = Configuration_GrammaticalGender_GrammaticalGender_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Configuration_GrammaticalGender_descriptor();
template<typename T>
inline const std::string& Configuration_GrammaticalGender_Name(T enum_t_value) {
  static_assert(::std::is_same<T, Configuration_GrammaticalGender>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function Configuration_GrammaticalGender_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    Configuration_GrammaticalGender_descriptor(), enum_t_value);
}
inline bool Configuration_GrammaticalGender_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, Configuration_GrammaticalGender* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<Configuration_GrammaticalGender>(
    Configuration_GrammaticalGender_descriptor(), name, value);
}
// ===================================================================
...
class Configuration final :
 ...
 public:
  ...
  typedef Configuration_GrammaticalGender GrammaticalGender;
  static constexpr GrammaticalGender GRAM_GENDER_USET =
    Configuration_GrammaticalGender_GRAM_GENDER_USET;
  static constexpr GrammaticalGender GRAM_GENDER_NEUTER =
    Configuration_GrammaticalGender_GRAM_GENDER_NEUTER;
  static constexpr GrammaticalGender GRAM_GENDER_FEMININE =
    Configuration_GrammaticalGender_GRAM_GENDER_FEMININE;
  static constexpr GrammaticalGender GRAM_GENDER_MASCULINE =
    Configuration_GrammaticalGender_GRAM_GENDER_MASCULINE;
  static inline bool GrammaticalGender_IsValid(int value) {
    return Configuration_GrammaticalGender_IsValid(value);
  }
  static constexpr GrammaticalGender GrammaticalGender_MIN =
    Configuration_GrammaticalGender_GrammaticalGender_MIN;
  static constexpr GrammaticalGender GrammaticalGender_MAX =
    Configuration_GrammaticalGender_GrammaticalGender_MAX;
  static constexpr int GrammaticalGender_ARRAYSIZE =
    Configuration_GrammaticalGender_GrammaticalGender_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  GrammaticalGender_descriptor() {
    return Configuration_GrammaticalGender_descriptor();
  }
  template<typename T>
  static inline const std::string& GrammaticalGender_Name(T enum_t_value) {
    static_assert(::std::is_same<T, GrammaticalGender>::value ||
      ::std::is_integral<T>::value,
      "Incorrect type passed to function GrammaticalGender_Name.");
    return Configuration_GrammaticalGender_Name(enum_t_value);
  }
  static inline bool GrammaticalGender_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      GrammaticalGender* value) {
    return Configuration_GrammaticalGender_Parse(name, value);
  }
  ...
  enum : int {
    ...
    kGrammaticalGenderFieldNumber = 26,
  };
  // string locale = 3;
  void clear_locale();
  ...
  // .aapt.pb.Configuration.GrammaticalGender grammatical_gender = 26;
  void clear_grammatical_gender();
  ::aapt::pb::Configuration_GrammaticalGender grammatical_gender() const;
  void set_grammatical_gender(::aapt::pb::Configuration_GrammaticalGender value);
  private:
  ::aapt::pb::Configuration_GrammaticalGender _internal_grammatical_gender() const;
  void _internal_set_grammatical_gender(::aapt::pb::Configuration_GrammaticalGender value);
  public:
...
// .aapt.pb.Configuration.GrammaticalGender grammatical_gender = 26;
inline void Configuration::clear_grammatical_gender() {
  _impl_.grammatical_gender_ = 0;
}
inline ::aapt::pb::Configuration_GrammaticalGender Configuration::_internal_grammatical_gender() const {
  return static_cast< ::aapt::pb::Configuration_GrammaticalGender >(_impl_.grammatical_gender_);
}
inline ::aapt::pb::Configuration_GrammaticalGender Configuration::grammatical_gender() const {
  // @@protoc_insertion_point(field_get:aapt.pb.Configuration.grammatical_gender)
  return _internal_grammatical_gender();
}
inline void Configuration::_internal_set_grammatical_gender(::aapt::pb::Configuration_GrammaticalGender value) {
  
  _impl_.grammatical_gender_ = value;
}
inline void Configuration::set_grammatical_gender(::aapt::pb::Configuration_GrammaticalGender value) {
  _internal_set_grammatical_gender(value);
  // @@protoc_insertion_point(field_set:aapt.pb.Configuration.grammatical_gender)
}
...
template <> struct is_proto_enum< ::aapt::pb::Configuration_GrammaticalGender> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::aapt::pb::Configuration_GrammaticalGender>() {
  return ::aapt::pb::Configuration_GrammaticalGender_descriptor();
}
